...
class ChatsController extends require("../../../Controller") {
   ...
   */
     ...
     async index(req, res, next, User = new Model) {

      User.find({},{limit: 5})
      User.once('find', users => res.render('app-chat', {users}))
      User.once('find-error', error => res.render('app-chat', {error}))
     }
