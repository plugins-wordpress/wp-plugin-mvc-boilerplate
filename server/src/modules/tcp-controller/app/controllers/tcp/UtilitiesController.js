 ...
 *
 * @module UtilitiesController
 * @kind class
 *
 * @extends base
 * @requires base
 *
 * @classdesc UtilitiesController class
 */

class UtilitiesController extends require("controller") {
    constructor(...arrayOfObjects) {
     ...
     // auto bind methods
     this.autobind(UtilitiesController);
     // auto invoke methods
     this.autoinvoker(UtilitiesController);
