...
|--------------------------------------------------------------------------------
|
| Connection extends the base model (Model) class and thus has everything
...
class Connection extends Model {
    ...
    |
    */
    constructor(dbOptions = { collection: 'connections', url: 'mongodb://localhost:27017/nodecraftsman', db: 'nodecraftsman' }, ...options) {
        ...
        */
        ...
        if (!this['hasOwnProperty']['collection']) this.collection = 'connections';
