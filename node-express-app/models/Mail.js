...
class Mail extends Model {
    ...
    |
    */
    constructor(dbOptions = { collection: 'mails', url: 'mongodb://localhost:27017/nodecraftsman', db: 'nodecraftsman' }, ...options) {
        ...
        */
        ...
        if (!this['hasOwnProperty']['collection']) this.collection = 'mails';
